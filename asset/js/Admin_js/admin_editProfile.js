...
function eEMpty() {
    ...
    var email_datas = '' +
        ...
        '&adminId=' + window.encodeURIComponent(adminId) +
    ...
    if (email == "") {
        ...
        xhttp.open('POST', '../../php/admin_php/admin_profileEditCheck.php,', true);
...
function ueMpty() {
    ...
    var instructorId = document.getElementById("adminId").value;
...
function profileEdit() {
    ...
    var adminInfo = JSON.stringify(myObj);
    var xttp = new XMLHttpRequest();
    xttp.open("POST", "../../php/admin_php/admin_profileEditCheck.php", true);
    xttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xttp.send('check_info=' + adminInfo);
